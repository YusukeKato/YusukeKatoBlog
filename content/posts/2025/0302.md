...
[Unity: WebGL: サーバー設定コードサンプル](https://docs.unity3d.com/ja/2021.2/Manual/webgl-server-configuration-code-samples.html)

## 参考
下記の記事を参考にさせていただきました。

[HatenaBlog: UnityのWebGLビルドをレンサバに設置する際やっとく設定のメモ](https://kumak1.hatenablog.com/entry/2021/09/13/000857)

[Qiita: UnityのWebGLでwasmのMIMEに関して表示される警告を回避する](https://qiita.com/oyaryo/items/44f17408f34d41276d61)
