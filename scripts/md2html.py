...
for markdown_file in markdown_files:
    ...
    write_lines.append('<link rel="stylesheet" href="https://yusukekato.jp/css/style.css?version=53">\n')
    ...
    series = ["lemon", "alpacahack", "shellgei", "ros2", "cooking", "others"]
    series_name = ["セキセイインコ「れもん」の日記", "AlpacaHackで始めるCTF入門", "シェル芸", "ROS 2", "料理日記", "その他"]
