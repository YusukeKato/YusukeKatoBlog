...
for markdown_file in markdown_files:
    ...
    write_lines.append('加藤祐介ブログの著作物はCC BY-NC-ND 4.0で公開されています。<br>\n')                                 write_lines.append('加藤祐介ブログのソフトウェアはMITライセンスで公開されています。<br>\n')                             write_lines.append('YusukeKatoBlog is licensed under <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer" style="display:inline-block;">CC BY-NC-ND 4.0</a>.<br>')     write_lines.append('YusukeKatoBlog Software is licensed under <a href="https://github.com/YusukeKato/YusukeKatoBlog/blob/main/LICENSE">MIT LICENSE</a>.<br>')
