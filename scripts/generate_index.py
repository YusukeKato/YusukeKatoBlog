...
write_lines.append('<link rel="stylesheet" href="https://yusukekato.jp/css/style.css?version=30">\n')
...
write_lines.append('</li>\n')
write_lines.append('<li class="nav-list-item">\n')
write_lines.append('<a href="https://twitter.com/yusukekato_main" class="bButton">X</a>\n')
write_lines.append('</li>\n')
write_lines.append('<li class="nav-list-item">\n')
write_lines.append('<a href="https://github.com/YusukeKato" class="bButton">GITHUB</a>\n')
write_lines.append('</li>\n')
write_lines.append('<li class="nav-list-item">\n')
write_lines.append('<a href="https://shellgei-online-judge.com/" class="bButton">SHELLGEI</a>\n')
write_lines.append('</li>\n')
