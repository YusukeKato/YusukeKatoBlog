...
write_lines.append('<link rel="stylesheet" href="https://yusukekato.jp/css/style.css?version=38">\n')
...
write_lines.append('<ul>\n')
write_lines.append('<li>2024/05/03: 1st Anniversary of SHELLGEI ONLINE JUDGE</li>\n')
write_lines.append('<li>2023/05/03: Start of SHELLGEI ONLINE JUDGE</li>\n')
write_lines.append('</ul>\n')
...
write_lines.append('<h1 class="heading-028-2" data-label="">Update : 2024.05.03<br>加藤祐介ブログはMITライセンスで公開されています。<br>Copyright Since 2023 (C) YusukeKato All Rights Reserved.</h1>\n')
write_lines.append('</body>\n')
