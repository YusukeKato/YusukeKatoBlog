...
write_lines.append('<meta property="og:description" content="加藤祐介のブログです。ROS/ROS 2やシェル芸、競技プログラミング、ゲーム製作などで日々遊んでいます。大学ではロボットについて勉強していました。備忘録的な記事をまとめていくのでよろしくお願いします。" />\n')
write_lines.append('<meta name="twitter:description" content="加藤祐介のブログです。ROS/ROS 2やシェル芸、競技プログラミング、ゲーム製作などで日々遊んでいます。大学ではロボットについて勉強していました。備忘録的な記事をまとめていくのでよろしくお願いします。" />\n')
write_lines.append('<title>加藤祐介ブログ / Yusuke Kato Blog</title>\n')
write_lines.append('<meta name="description" content="加藤祐介のブログです。ROS/ROS 2やシェル芸、競技プログラミング、ゲーム製作などで日々遊んでいます。大学ではロボットについて勉強していました。備忘録的な文章をまとめていくのでよろしくお願いします。" />\n')
...
write_lines.append('<link rel="stylesheet" href="https://yusukekato.jp/css/style.css?version=41">\n')
...
write_lines.append('<p>ロボット（ROS/ROS 2など）やシェル芸、競技プログラミング（AtCoderなど）、ゲーム製作（Unityなど）などで日々遊んでいます。\n')
...
write_lines.append('<h1 class="heading-028-2" data-label="" xmlns:cc="http://creativecommons.org/ns#" xmlns:dct="http://purl.org/dc/terms/">加藤祐介ブログの著作物はCC BY-NC-ND 4.0で公開されています。<br>加藤祐介ブログのソフトウェアはMITライセンスで公開されています。<br>YusukeKatoBlog is licensed under <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/?ref=chooser-v1" target="_blank" rel="license noopener noreferrer" style="display:inline-block;">CC BY-NC-ND 4.0<img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/nc.svg?ref=chooser-v1" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/nd.svg?ref=chooser-v1" alt=""></a>.<br>YusukeKatoBlog Software is licensed under <a href="https://github.com/YusukeKato/YusukeKatoBlog/blob/main/LICENSE">MIT LICENSE</a>.<br>Copyright Since 2023 (C) YusukeKato All Rights Reserved.</h1>\n')
write_lines.append('</body>\n')
